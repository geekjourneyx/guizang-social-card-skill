...
- 🎨 **11 套主题预设**:Editorial 7 套(墨水经典、靛蓝瓷、森林墨、牛皮纸、沙丘、**Midnight Ink**、**Jieni Gold** 两套暗色)+ Swiss 4 套锚点色(IKB Klein Blue、柠檬黄、柠檬绿、安全橙)
...
2. **Style & Theme** — 选 Editorial 还是 Swiss,再从 11 套预设里选主题色。不允许自定义 hex
...
| 🟨 **杰尼金 Jieni Gold** | `#050505` / `#f1efe8` / `#c9a45c` | AI / Harness / 开源 / 产品 / 个人品牌图像 |
...
├── assets/
│   ├── template-editorial-card.html      ← Editorial 种子(7 主题 / 3 画板)
...
**为什么不允许自定义颜色?**
和 PPT skill 同样的理由——这个 Skill 的核心价值是稳定产出。自由选色会破坏整体风格,只允许从 11 套预设里挑。
