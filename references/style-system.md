...
Use one of the 8 magazine palettes in `theme-presets.md`: 6 light and 2 dark. Do not improvise arbitrary warm paper or dark colors. The two sanctioned dark palettes are **Midnight Ink** for game art, night photography, and dark cultural imagery, and **Jieni Gold** for sparse launch covers, cinematic hero statements, and brand closes. **Jieni Ivory** is a light, reading-first companion for tutorials, explainers, screenshots, processes, data, and sustained mobile reading; a multi-page instructional Jieni package uses Ivory on the root and may use Gold only on its first and/or last poster, never for variety. Do not invent a third dark palette.
